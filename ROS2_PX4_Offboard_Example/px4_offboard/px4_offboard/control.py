...
Press F to enable/disable hover
"""
...
def main():
    ...
    hover_toggle = False
    hover_pub = node.create_publisher(std_msgs.msg.Bool, '/hover_message', qos_profile)
    ...
    try:
        ...
        while True:
            ...
            if key == 'f':
                ...
                hover_msg = std_msgs.msg.Bool()
                hover_msg.data = hover_toggle
                hover_pub.publish(hover_msg)
                print(f"Hover toggle is now: {hover_toggle}")
            ...
            if key == 'l':
                ...
                print(f"Landing now, land is {land_toggle}")
                land_toggle = False
